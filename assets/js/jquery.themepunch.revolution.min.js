...
!function(jQuery, undefined) {
    ...
    var _ISM = _R.is_mobile()
            ...
            if (c.data("loaded") === undefined && f !== undefined && f.progress && f.progress.match(/loaded/g)) {
                ...
                "img" == f.type)
                    if (c.hasClass("defaultimg"))
                        _R.isIE(8) ? defimg.attr("src", f.src) : -1 == f.src.indexOf("images/transparent.png") || c.data("bgcolor") === undefined ? c.css({
      ...
      , letItFree = function(a, b, c, d, e, f) {
        ...
        g.startWithSlide !== undefined && "done" !== g.startWithSlide && (_R.callingNewSlide(g.c, g.startWithSlide),
